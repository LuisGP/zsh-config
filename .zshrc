...
# Path to your oh-my-zsh installation.
  export ZSH="/home/lgasco/.oh-my-zsh"
...
# My own PROMPT configuration
# PROMPT="%{$fg[cyan]%}$USER@%{$fg[blue]%}%m%{$reset_color%} ${PROMPT}"
...
#MODE_VI_INDICATOR=">>>" #"NORMAL"
#MODE_NO_INDICATOR=">" #"INSERT"
#
